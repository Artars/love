...
namespace Mirror {
    ...
    public class NetworkDiscovery : MonoBehaviour {
        ...
        [HideInInspector]
        public byte[] handshakeData { get; set; } = ByteStreamer.StreamToBytes("Auf geht's maenner! Wir haben keine Zeit, also marsch marsch!");
        ...
        public int ActiveDiscoverySecondInterval
        {
            get{ return m_ActiveDiscoverySecondInterval;}
        }
